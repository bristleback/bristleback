== Bristleback Framework version 0.2.1
Welcome,
...
Latest Bristleback version: 0.2.1, version 0.3.0 is under development on separate branch.
...
1. Go to directory where your new Bristleback Project will be created and type:
    ...
    mvn archetype:generate
      -DarchetypeCatalog=http://bristleback.pl/archetype/archetype-catalog.xml
